  ...
  _createClass(Group, [{
    ...
    value: function setState(stateKey, value) {
      ...
      if (!this.is_running) {
        this.subscribeMap["@mount"].push(function () {
          return _this2._setState(stateKey, value);
        });
        return;
      }
    ...
    value: function mountGroup(name, group) {
      ...
      var mountChild = function mountChild() {
        ...
        noRootGroup.path = _this3.name + "/" + group.name;
        noRootGroup.parent = _this3;
        _this3.childrenMap[name] = noRootGroup;
        noRootGroup.root = _this3.root;

        _broker2.default.addListener("groupMount", _this3._groupMountHandler.bind(_this3));
        _broker2.default.addListener("groupUmount", _this3._groupUnmountHandler.bind(_this3));
        _broker2.default.addListener("groupChange", _this3._groupChangeHandler.bind(_this3));
    ...
    value: function unmountGroup(name) {
      ...
      _broker2.default.removeListener("groupMount", this._groupMountHandler.bind(this));
      _broker2.default.removeListener("groupUmount", this._groupUnmountHandler.bind(this));
      _broker2.default.removeListener("groupChange", this._groupChangeHandler.bind(this));
    ...
    value: function _setState(stateKey, value) {
      // metrics
      _broker2.default.emit("groupChange", { group: this, timestamp: Date.now(), changedState: _defineProperty({}, stateKey, value) });
